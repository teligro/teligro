...
class WPCerberSecurity extends Teligro {
	...
	function event_action( $body, $params ) {
		...
		$body = Helpers::br2nl( $body );
		$text .= wp_strip_all_tags( $body ) . "\n";

		$text .= __( 'Date', $this->plugin_key ) . ': ' . Helpers::localeDate() . "\n";
		$text = apply_filters( 'teligro_wpcerbersecurity_event_notification_text', $text, $body, $params );
	 ...
	 * @return WPCerberSecurity
	 */
	static function getInstance() {
		if ( self::$instance == null )
			self::$instance = new WPCerberSecurity();

		return self::$instance;
	}
}

WPCerberSecurity::getInstance();