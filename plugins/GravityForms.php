...
class GravityForms extends Teligro {
	...
	function gravityforms_submit( $entry, $form ) {
		...
		$text .= __( 'Date', $this->plugin_key ) . ': ' . Helpers::localeDate( $entry['date_created'] ) . "\n";

		$text = apply_filters( 'teligro_gravityforms_message_notification_text', $text, $entry, $form );
	...
	static function getInstance() {
		if ( self::$instance == null )
			self::$instance = new GravityForms();
