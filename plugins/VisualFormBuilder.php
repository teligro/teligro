...
class VisualFormBuilder extends Teligro {
	...
	function form_submit( $form_id ) {
		...
		$text = apply_filters( 'teligro_visualformbuilder_message_notification_text', $text, $fields, $entry_id,
			$form_id );
	...
	static function getInstance() {
		if ( self::$instance == null )
			self::$instance = new VisualFormBuilder();

		return self::$instance;
	}
}

VisualFormBuilder::getInstance();