...
class HappyForms extends Teligro {
	...
	function form_submit( $submission, $form ) {
		...
		$text = apply_filters( 'teligro_happyforms_message_notification_text', $text, $submission, $form );
	...
	static function getInstance() {
		if ( self::$instance == null )
			self::$instance = new HappyForms();

		return self::$instance;
	}
}

HappyForms::getInstance();