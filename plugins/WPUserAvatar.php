...
class WPUserAvatar extends Teligro {
        ...
        <tr>
            <th colspan="2" class="title-with-icon">
                <img src="data:image/png;base64,"
                     class="pg-icon" alt="WP User Avatar">
	...
	function avatar_change_notification( $meta_id, $user_id, $meta_key, $meta_value ) {
		...
		$text = apply_filters( 'teligro_wpuseravatar_avatar_change_notification_text', $text, $meta_id, $user_id,
			$meta_key, $meta_value );
	...
	static function getInstance() {
		if ( self::$instance == null )
			self::$instance = new WPUserAvatar();

		return self::$instance;
	}
}

WPUserAvatar::getInstance();