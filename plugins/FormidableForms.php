...
class FormidableForms extends Teligro {
	...
	function formidable_submit( $entry_id, $form_id ) {
		...
		$text = apply_filters( 'teligro_formidable_message_notification_text', $text, $entry_id, $form_id );
	 ...
	 * @return FormidableForms
	 */
	static function getInstance() {
		if ( self::$instance == null )
			self::$instance = new FormidableForms();

		return self::$instance;
	}
}

FormidableForms::getInstance();