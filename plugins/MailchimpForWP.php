...
class MailchimpForWP extends Teligro {
	...
	private function send_notification( $email, $form, $event = 'subscribed' ) {
		...
		$text = apply_filters( 'teligro_mailchimpforwp_new_subscriber_notification_text', $text, $email, $form,
			$event );
	 ...
	 * @return MailchimpForWP
	 */
	static function getInstance() {
		if ( self::$instance == null )
			self::$instance = new MailchimpForWP();

		return self::$instance;
	}
}

MailchimpForWP::getInstance();