...
class HTMLForms extends Teligro {
	...
	function form_submit( $submission, $form ) {
		...
		$text = apply_filters( 'teligro_htmlforms_message_notification_text', $text, $submission, $form );
	...
	static function getInstance() {
		if ( self::$instance == null )
			self::$instance = new HTMLForms();

		return self::$instance;
	}
}

HTMLForms::getInstance();