...
class NinjaForms extends Teligro {
	...
	function ninjaforms_submit( $form_data ) {
		...
		$text = apply_filters( 'teligro_ninjaforms_message_notification_text', $text, $form_data );
	...
	static function getInstance() {
		if ( self::$instance == null )
			self::$instance = new NinjaForms();

		return self::$instance;
	}
}

NinjaForms::getInstance();