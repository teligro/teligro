...
class BackWPup extends Teligro {
	...
	function send_log( $args ) {
		...
		$text = apply_filters( 'teligro_backwpup_send_log_notification_text', $text, $args );
	...
	static function getInstance() {
		if ( self::$instance == null )
			self::$instance = new BackWPup();

		return self::$instance;
	}
}

BackWPup::getInstance();