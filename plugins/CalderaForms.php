...
class CalderaForms extends Teligro {
	...
	function form_submit( $form, $referrer, $process_id, $entryid ) {
		...
		$text = apply_filters( 'teligro_calderaforms_message_notification_text', $text, $form );
	...
	static function getInstance() {
		if ( self::$instance == null )
			self::$instance = new CalderaForms();

		return self::$instance;
	}
}

CalderaForms::getInstance();