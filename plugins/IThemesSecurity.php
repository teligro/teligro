...
class IThemesSecurity extends Teligro {
	...
	function new_blacklisted_ip( $ip ) {
		...
		$text = apply_filters( 'teligro_ithemessecurity_new_blacklisted_ip_notification_text', $text, $ip );
	...
	static function getInstance() {
		if ( self::$instance == null )
			self::$instance = new IThemesSecurity();

		return self::$instance;
	}
}

IThemesSecurity::getInstance();