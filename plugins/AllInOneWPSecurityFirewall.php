...
class AllInOneWPSecurityFirewall extends Teligro {
	...
	function new_blacklisted_ip( $ip_range, $username ) {
		...
		$text = apply_filters( 'teligro_allinonewpsecurityfirewall_lock_user_notification_text', $text, $ip_range,
			$username );
	 ...
	 * @return AllInOneWPSecurityFirewall
	 */
	static function getInstance() {
		if ( self::$instance == null )
			self::$instance = new AllInOneWPSecurityFirewall();

		return self::$instance;
	}
}

AllInOneWPSecurityFirewall::getInstance();