...
class WPForms extends Teligro {
        ...
        <tr>
            ...
            <td>
				...
				$this->post_type_select( 'wpforms_forms_select[]', 'wpforms', array(
					'multiple' => 'multiple',
					'selected' => $this->get_option( 'wpforms_forms_select',
						[] ),
	...
	function wpforms_submit( $fields, $entry, $form_data, $entry_id ) {
		...
		$text = apply_filters( 'teligro_wpforms_message_notification_text', $text, $fields, $entry, $form_data,
			$entry_id );
