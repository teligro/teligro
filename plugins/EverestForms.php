...
class EverestForms extends Teligro {
	...
	function form_submit( $form_fields, $entry, $form_data, $entry_id ) {
		...
		$text = apply_filters( 'teligro_everestforms_message_notification_text', $text, $form_fields, $entry,
			$form_data, $entry_id );
	...
	static function getInstance() {
		if ( self::$instance == null )
			self::$instance = new EverestForms();

		return self::$instance;
	}
}

EverestForms::getInstance();